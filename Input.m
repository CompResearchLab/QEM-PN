...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mesh settings
n=150; % number of grid points per block in each direction
...
URS=40; % Number of random samples
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
H=16E-9; % Height of each block (m)
W=16E-9; % Width of each block
Shift=1E-9; % shift of the gaussian potential in each block
MaxRadius=6.5E-9; % max radius for each block
MinRadius=5E-9; % minimum radius for each block
Depth=0.8; %depth of each guassian potential (eV)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Training settings
RS=30; % number of random samples for each structure
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
USize=100; % Number of UModes to train
...
% own.
Trows=2; % Total number of rows of elements
Tcols=2; % Total number of cols of elements
...
UMU=20; % Number of U Modes used if using 'C'
Drop=1E-7; % Number of U modes used if selected 'D'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% If DoM is set to 'D' and using POD U modes, plots showing the accuracy of the projected
% the mode of choose will appear when finished. The plot's x-axis is based
...
HTest=false; % Select true if you want to sweep across hamiltonian sizes and plot the average error
...
% paper____. By projecting each the potential onto a know basis the
% U-Matrix for each element can be mostly precomputed before runtime.
% During runtime the only thing which needs to be computed is the basis
% coefficients.
...
% The fourier library must be built before running PODrunner.m
...
skip=5; % Can only be 5,10,15,20,25 or 30
...
global SB; SB=10; % Number of boundary points to skip (Only takes effect during training)
global Br; Br=5; %Boundary spacing resolution
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plotting settings for the LSE plot regarding POD modes
contours=false % Plot contour plots
savefigsI=true %Save figures;
PlotScale=-.3; %Factor to Scale WFs to plot
...
PS=1; % Increment by Rows and columns by a greated number than 1 to reduce the number of Potential Error Plots
nB=20; % Since the center of the potential is the most accurate you can compute the Potential error of points nB:end-nB only.
